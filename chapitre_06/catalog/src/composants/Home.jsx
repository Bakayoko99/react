...
class Home extends Component {
    ...
    //         let filmSelected= films.filter((elem) => {
    //             if (elem[i] === parseInt(this.props.match.params.id)) {
    //                 return elem[i]
    //             }
    //         })
    ...
    render() {
        ...
        console.log("films selectionee :",films[0].id);
        ...
        console.log( "id params: ",parseInt(this.props.match.params.id));
        console.log("filmselected var",filmSelected);
        // console.log("filmSelected",filmSelected);
